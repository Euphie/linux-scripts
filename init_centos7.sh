...
update_kernel()
{
    ...
    sed -i '/GRUB_DEFAULT=/s#saved#0#' /etc/default/grub
...
{
    wget https://get.daocloud.io/docker/compose/releases/download/1.24.0/docker-compose-`uname -s`-`uname -m` -o /usr/local/bin/docker-compose
